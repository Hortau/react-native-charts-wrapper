...
public class PieChartManager extends ChartBaseManager<PieChart, PieEntry> {
    ...
    public void setStyledCenterText(PieChart chart, ReadableMap propMap) {
        ...
        if (BridgeUtils.validate(propMap, ReadableType.String, "fontFamily") ||
                BridgeUtils.validate(propMap, ReadableType.String, "fontWeight")) {
    ...
    @ReactProp(name = "entryLabelTypeface")
    public void setEntryLabelTypeface(PieChart chart, ReadableMap propMap) {
        if (BridgeUtils.validate(propMap, ReadableType.String, "fontWeight")) {
            chart.setEntryLabelTypeface(TypefaceUtils.getTypeface(chart, propMap));
        }
    }
